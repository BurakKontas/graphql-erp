-- MySQL adapted version of V9__finance.sql
-- Types adapted from PostgreSQL
...
CREATE TABLE IF NOT EXISTS sales_invoice_lines (
    ...
    line_total_with_tax DECIMAL(19,2) DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS credit_notes (
    ...
    status VARCHAR(20) NOT NULL DEFAULT 'DRAFT',
    total DECIMAL(19,2) DEFAULT 0,
    applied_amount DECIMAL(19,2) DEFAULT 0,
    reason TEXT,
...
WHERE rp.role_id IS NULL
  AND p.module IN ('ACCOUNT','ACCOUNTING_PERIOD','JOURNAL_ENTRY','SALES_INVOICE','PAYMENT','CREDIT_NOTE','EXPENSE');
