-- MySQL adapted version of V8__shipment.sql
CREATE TABLE delivery_orders (
    ...
    CONSTRAINT fk_delivery_order_company FOREIGN KEY (company_id) REFERENCES companies (id),
...
CREATE TABLE delivery_order_lines (
    ...
    CONSTRAINT fk_do_line_delivery_order FOREIGN KEY (delivery_order_id) REFERENCES delivery_orders (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE shipment_lines (
    ...
    CONSTRAINT fk_shipment_line_shipment FOREIGN KEY (shipment_id) REFERENCES shipments (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE shipment_returns (
    ...
    tenant_id VARCHAR(36) NOT NULL,
    company_id VARCHAR(36) NOT NULL,
    shipment_return_number VARCHAR(20) NOT NULL,
    ...
    CONSTRAINT fk_shipment_return_company FOREIGN KEY (company_id) REFERENCES companies (id),
    CONSTRAINT uq_shipment_return_number UNIQUE (tenant_id, shipment_return_number)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE shipment_return_lines (
    id VARCHAR(36) PRIMARY KEY,
    shipment_return_id VARCHAR(36) NOT NULL,
    ...
    CONSTRAINT fk_sr_line_shipment_return FOREIGN KEY (shipment_return_id) REFERENCES shipment_returns (id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE INDEX idx_sr_line_shipment_return_id ON shipment_return_lines (shipment_return_id);

-- Permissions inserts unchanged
