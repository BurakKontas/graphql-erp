-- MySQL adapted version of V11__hr.sql
...
CREATE TABLE IF NOT EXISTS positions (
    ...
    UNIQUE KEY uq_positions (tenant_id, company_id, code),
...
CREATE TABLE IF NOT EXISTS hr_employees (
    ...
    UNIQUE KEY uq_hr_employee (tenant_id, employee_number),
    CONSTRAINT fk_hr_emp_company FOREIGN KEY (company_id) REFERENCES companies(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS contracts (
    ...
    UNIQUE KEY uq_contract (tenant_id, contract_number),
...
CREATE TABLE IF NOT EXISTS leave_requests (
    ...
    UNIQUE KEY uq_leave_request (tenant_id, request_number),
...
CREATE TABLE IF NOT EXISTS leave_balances (
    ...
    UNIQUE KEY uq_leave_balance (tenant_id, employee_id, leave_type, year),
...
CREATE TABLE IF NOT EXISTS attendances (
    ...
    notes TEXT,
    UNIQUE KEY uq_attendance (tenant_id, employee_id, date),
...
CREATE TABLE IF NOT EXISTS payroll_runs (
    ...
    payroll_config_id VARCHAR(36),
    entries_json TEXT,
    UNIQUE KEY uq_payroll_run (tenant_id, run_number),
...
CREATE TABLE IF NOT EXISTS performance_cycles (
    ...
    goals_json TEXT,
    CONSTRAINT fk_performance_cycles_company FOREIGN KEY (company_id) REFERENCES companies(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS performance_reviews (
    ...
    UNIQUE KEY uq_perf_review (tenant_id, cycle_id, employee_id),
    CONSTRAINT fk_performance_reviews_company FOREIGN KEY (company_id) REFERENCES companies(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS job_postings (
    ...
    published_at DATE,
    closing_date DATE,
    UNIQUE KEY uq_job_posting (tenant_id, posting_number),
...
CREATE TABLE IF NOT EXISTS job_applications (
    ...
    CONSTRAINT fk_job_apps_company FOREIGN KEY (company_id) REFERENCES companies(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
